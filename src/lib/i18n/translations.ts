  ...
  ru: {
    ...
    vacancies: {
      ...
      form: {
        ...
        subtitle: 'Заполните данные, чтобы опубликовать новую вакансию',
        linkedPosition: 'Связанная должность (из карьерных карт)',
        selectPosition: '— Выберите должность —',
        titlePlaceholder: 'например, Старший инженер-технолог',
        departmentPlaceholder: 'например, Производство',
        salaryMin: 'Мин. зарплата (сум)',
        salaryMax: 'Макс. зарплата (сум)',
        shift: 'Смена',
        shiftDay: 'Дневная',
        shiftNight: 'Ночная',
        shiftFlex: 'Гибкая',
    ...
    landing: {
      eyebrow: 'Набор персонала // 2026',
      heroTitleA: 'Начните карьеру',
      heroTitleB: 'в компании Nexo',
      ...
      openPositions: 'открытых позиций сейчас',
      ...
      about: {
        title: 'О нас',
        lead: 'Nexo HR — платформа, автоматизирующая HR-процессы производственных компаний: от подбора персонала до развития карьеры сотрудников.',
        missionTitle: 'Наша миссия',
        missionText: 'Перевести управление персоналом с бумаги и ручного труда на единую цифровую платформу и помочь компаниям принимать решения на основе данных.',
        futureTitle: 'Наше будущее',
        futureText: 'Мы развиваем ИИ-подбор кандидатов, мобильное приложение и расширенную аналитику, чтобы стать ведущей HR-платформой в регионе.',
      },
      saas: {
        title: 'Подключите свою компанию к Nexo HR',
        text: 'Получите доступ к SaaS-версии платформы и автоматизируйте HR-процессы вашей компании уже сегодня.',
        cta: 'Подключиться',
      },
      contact: {
        title: 'Связаться с нами',
        lead: 'Оставьте заявку — мы свяжемся с вами в ближайшее время.',
        fullName: 'Имя и фамилия',
        fullNamePlaceholder: 'Введите имя и фамилию',
        phone: 'Номер телефона',
        phonePlaceholder: '+998 90 123 45 67',
        message: 'Комментарий к обращению',
    ...
    forgotPasswordHint: 'Для сброса пароля обратитесь к вашему HR-администратору — он сможет установить новый пароль в панели управления.',
  ...
  uz: {
    ...
    vacancies: {
      ...
      form: {
        ...
        subtitle: "Yangi vakansiyani e'lon qilish uchun ma'lumotlarni to'ldiring",
        linkedPosition: "Bog'liq lavozim (karyera xaritalaridan)",
        selectPosition: '— Lavozimni tanlang —',
        titlePlaceholder: 'masalan, Katta texnolog',
        departmentPlaceholder: 'masalan, Ishlab chiqarish',
        salaryMin: "Min. ish haqi (so'm)",
        salaryMax: "Maks. ish haqi (so'm)",
        shift: 'Smena',
        shiftDay: 'Kunduzgi',
        shiftNight: 'Tungi',
        shiftFlex: "Moslashuvchan",
      }
    },
    applications: {
      title: 'Arizalar',
    ...
    landing: {
      eyebrow: 'Xodimlar qabuli // 2026',
      heroTitleA: 'Karyerangizni',
      heroTitleB: 'Nexoda boshlang',
      ...
      openPositions: 'ta ochiq lavozim hozir',
      ...
      about: {
        title: 'Biz haqimizda',
        lead: "Nexo HR — ishlab chiqarish korxonalarining HR jarayonlarini avtomatlashtiruvchi platforma: xodim qabulidan tortib martaba rivojlanishigacha.",
        missionTitle: 'Bizning missiyamiz',
        missionText: "Xodimlarni boshqarishni qog'oz va qo'lda ishlashdan yagona raqamli tizimga o'tkazish va korxonalarga ma'lumotga asoslangan qarorlar qabul qilishga yordam berish.",
        futureTitle: 'Bizning kelajagimiz',
        futureText: "Biz AI-asosidagi nomzod saralash, mobil ilova va kengaytirilgan analitikani rivojlantirmoqdamiz — mintaqadagi yetakchi HR platformasiga aylanish uchun.",
      },
      saas: {
        title: 'Kompaniyangizni Nexo HR-ga ulang',
        text: "Platformaning SaaS versiyasidan foydalaning va kompaniyangiz HR jarayonlarini bugundan avtomatlashtiring.",
        cta: 'Ulanish',
      },
      contact: {
        title: 'Biz bilan bog\'laning',
        lead: "Murojaat qoldiring — tez orada siz bilan bog'lanamiz.",
        fullName: 'Ism va familiya',
        fullNamePlaceholder: 'Ism va familiyangizni kiriting',
        phone: 'Telefon raqami',
        phonePlaceholder: '+998 90 123 45 67',
        message: 'Murojaat izohi',
        messagePlaceholder: 'Sizga qanday yordam bera olishimizni yozing',
        submit: 'Murojaat yuborish',
        submitting: 'Yuborilmoqda…',
        success: "Rahmat! Murojaatingiz yuborildi, tez orada siz bilan bog'lanamiz.",
        error: "Murojaatni yuborib bo'lmadi. Qaytadan urinib ko'ring.",
      },
    },
    candidateDashboard: {
    ...
    forgotPasswordHint: "Parolni tiklash uchun HR-administratoringizga murojaat qiling — u boshqaruv panelida sizga yangi parol o'rnatib bera oladi.",
    ...
    create: 'Yaratish',
    delete: 'O\'chirish',
    backToCandidates: 'Nomzodlarga qaytish',
    edit: 'Tahrirlash',
    save: 'Saqlash',
    cancel: 'Bekor qilish',
    firstName: 'Ism',
