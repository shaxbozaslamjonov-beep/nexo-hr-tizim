export const translations = {
  ru: {
    ...
    forgotPasswordHint: 'Введите email, привязанный к вашему аккаунту, — если к нему подключён Telegram, мы отправим туда ссылку для сброса пароля. Если Telegram не подключён, обратитесь к вашему HR-администратору.',
    forgotPasswordSubmit: 'Отправить ссылку',
    forgotPasswordSent: 'Если такой email зарегистрирован и Telegram подключён, ссылка для сброса пароля отправлена в ваш чат.',
    ...
    resetPasswordSuccess: 'Пароль обновлён! Сейчас вы будете перенаправлены на страницу входа.',
    resetPasswordInvalidLink: 'Ссылка недействительна или устарела. Запросите новую через "Забыли пароль?".',
    passwordsDontMatch: 'Пароли не совпадают',
    backToLogin: '← Назад к входу',
    noAccount: 'Нет аккаунта?',
    haveAccount: 'Уже есть аккаунт?',
    registerAsEmployee: 'Я сотрудник / кандидат',
    registerAsCompany: 'Я регистрирую компанию',
    companyName: 'Название компании',
    companyNamePlaceholder: 'ООО «Моя Компания»',
    lessons: 'Уроки',
  ...
  uz: {
    ...
    forgotPasswordHint: "Akkauntingizga bog'langan emailni kiriting — agar unga Telegram ulangan bo'lsa, parolni tiklash havolasini o'sha chatga yuboramiz. Telegram ulanmagan bo'lsa, HR-administratoringizga murojaat qiling.",
    forgotPasswordSubmit: 'Havola yuborish',
    forgotPasswordSent: "Agar shu email ro'yxatdan o'tgan va Telegram ulangan bo'lsa, parolni tiklash havolasi Telegram chatingizga yuborildi.",
    resetPasswordTitle: 'Yangi parol',
    resetPasswordHint: 'Akkauntingiz uchun yangi parol kiriting.',
    resetPasswordSubmit: 'Parolni saqlash',
    resetPasswordSuccess: "Parol yangilandi! Hozir kirish sahifasiga yo'naltirilasiz.",
    resetPasswordInvalidLink: "Havola yaroqsiz yoki muddati o'tgan. \"Parolni unutdingizmi?\" orqali yangisini so'rang.",
    passwordsDontMatch: 'Parollar mos kelmadi',
    backToLogin: '← Kirishga qaytish',
    noAccount: 'Akkauntingiz yo\'qmi?',
    haveAccount: 'Akkauntingiz bormi?',
    registerAsEmployee: 'Men xodim / nomzodman',
    registerAsCompany: 'Men kompaniya ro\'yxatdan o\'tkazyapman',
    companyName: 'Kompaniya nomi',
    companyNamePlaceholder: '"Mening Kompaniyam" MChJ',
    lessons: 'Darslar',
